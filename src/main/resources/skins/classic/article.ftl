        ...
        <div class="article-info fn-flex">
            ...
            <a rel="author" href="${servePath}/member/${article.articleAuthorName}"></#if>
                <div
                        ...
                        style="background-image:url('${article.articleAuthorThumbnailURL48}')"></div><#if article.articleAnonymous == 0>
            </a></#if>
...
<div class="article-header">
    <a href="${servePath}" style="outline: 0;text-decoration: none;color: white;">
